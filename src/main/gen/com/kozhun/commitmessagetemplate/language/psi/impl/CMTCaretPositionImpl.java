...
public class CMTCaretPositionImpl extends ASTWrapperPsiElement implements CMTCaretPosition {

  public CMTCaretPositionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CMTVisitor visitor) {
    visitor.visitCaretPosition(this);
  }
